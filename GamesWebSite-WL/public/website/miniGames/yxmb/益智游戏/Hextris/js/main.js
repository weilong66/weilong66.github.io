...
function showHelp() {
	...
	$("#inst_main_body").html(
		"<div id = 'instructions_head'>游戏教程</div><p>Hextris 的目标是阻止方块超出外层大的灰色六边形。</p><p>"
		+ (settings.platform != 'mobile' ? '按向左箭头键(←)和向右箭头键(→)' : '点击屏幕的左右两侧') + " 来旋转中间的六边形."
		+ (settings.platform != 'mobile' ? '<br/>按下向下箭头键(↓)可以加速方块下落。' : '')
		+ "<p>Hextris 的目标是阻止方块超出外层灰色的大六边形。</p>" +
		"<p>将相同颜色的方块相接触，如果数量达到3个或以上，这些方块将会被清除并获得分数。</p>" +
		"<p>在大六边形外部的 <span style='color:#f1c40f;'>彩</span><span style='color:#e74c3c'>色</span><span style='color:#3498db'>线</span><span style='color:#2ecc71'>条</span> 指示了你的连击将在多长时间后消失。</p>" +
		"<p>由 <a href='http://loganengstrom.com' target='_blank'>Logan Engstrom</a> 和 <a href='http://github.com/garrettdreyfus' target='_blank'>Garrett Finucane</a> 制作。</p>" +
		"<p>在 <a href = 'https://itunes.apple.com/us/app/id903769553?mt=8' target='_blank'>iOS</a> 和 <a href ='https://play.google.com/store/apps/details?id=io.cordova.hextris' target='_blank'>Android</a> 上找到 Hextris。</p>" +
		"<p>更多内容请访问 <a href ='http://hextris.github.io/' target='_blank'>Hextris 网站</a>。</p>"
	);
	if (gameState == 1) {
		pause();
	}
