...
function showText(text) {
	/* var messages = {
		...
		'pausedAndroid': "<div class='centeredHeader unselectable'>游戏暂停</div><div class='unselectable centeredSubHeader' style='position:absolute;margin-left:-150px;left:50%;margin-top:20px;width:300px;font-size:16px;'><a href = 'https://play.google.com/store/apps/details?id=com.hextris.hextrisadfree' target='_blank'>想支持开发者吗？点击这里访问Hextris官网！</a></div>",
		'pausediOS': "<div class='centeredHeader unselectable'>游戏暂停</div><div class='unselectable centeredSubHeader' style='position:absolute;margin-left:-150px;left:50%;margin-top:20px;width:300px;font-size:16px;'><a href = 'https://itunes.apple.com/us/app/hextris-ad-free/id912895524?mt=8' target='_blank'>想支持开发者吗？点击这里访问Hextris官网！</a></div>",
		'pausedOther': "<div class='centeredHeader unselectable'>游戏暂停</div><div class='unselectable centeredSubHeader' style='margin-top:30px;position:absolute;left:50%;margin-left:-190px;max-width:380px;font-size:18px;'><a href = 'http://hextris.github.io/' target='_blank'>想支持开发者吗？点击这里访问Hextris官网！</a></div>",
		'start': "<div class='centeredHeader unselectable' style='line-height:80px;'>按 Enter 开始</div>"
	}; */
	var messages = {
		'paused': "<div class='centeredHeader unselectable'>游戏暂停</div>",
