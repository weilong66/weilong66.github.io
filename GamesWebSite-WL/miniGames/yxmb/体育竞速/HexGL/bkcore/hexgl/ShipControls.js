...
bkcore.hexgl.ShipControls = function(ctx)
{
	...
	else if(ctx.controlType == 2)
	{
		...
		function updateInfo()
		{
			...
			{
				leapInfo.innerHTML = '正在等待 Leap Motion Controller 设备连接...'
			...
			{
				leapInfo.innerHTML = '请连接您的 Leap Motion Controller.'
				leapInfo.style.display = 'block';
			}
			else if(!lb.hasHands)
			{
				leapInfo.innerHTML = '请把你的手放在 Leap Motion Controller 前游玩游戏.'
				leapInfo.style.display = 'block';
			}
		}
		updateInfo();
