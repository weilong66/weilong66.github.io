...
(function(){
  ...
  /* 这里定义玩家，
  注意：第一个玩家最后一个参数需要设为true
   */
const Players = [
    new Player("玩家 1","#056305", 0, 0, true),
    new Player("玩家 2","orange", 0, 0, false),
    // new Player("玩家 3","black", 0, 0, false),
    // new Player("玩家 4","#0FF", 0, 0, false),
    // new Player("玩家 5","#b70505", 0, 0, false)
    ];
...
append(coverSpan,document.createTextNode('# 开始 #'));
...
append(restartSpan,document.createTextNode('# 重置'));
