//Note from the website this is on:
//This is not my work, and I do not take credit for it...
//the rest was made by codepen
...
class drawing {
    ...
    drawGrid(gridInstance, heroInstance) {
        ...
        this.drawMovingtext("按空格键开始", 70, 102, 255, 1, 60, [0, 16], [10, 16], heroInstance);
        this.drawMovingtext("按空格键跳跃", 70, 102, 255, 1, 60, [50, 16], [80, 16], heroInstance);
        this.drawMovingtext("按住空格键以连续跳跃", 70, 102, 255, 1, 60, [110, 16], [140, 16], heroInstance);
        this.drawMovingtext("按下S键添加存档点", 70, 102, 255, 1, 60, [170, 16], [200, 16], heroInstance);
