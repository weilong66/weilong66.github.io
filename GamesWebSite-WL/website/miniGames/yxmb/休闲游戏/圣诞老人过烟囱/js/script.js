...
const introductionElement = createElementStyle(
  "div",
  `font-size:1.2em;position:absolute;text-align:center;transition:opacity 2s;width:250px;color:#ffffff;background-color:rgb(135 6 6);`,
  "按住任何地方都可以伸展拐杖糖，它必须是精确的长度，否则圣诞老人会掉下去."
);
...
function playMusic() {
  if (!musicPlaying) {
    ...
    source.src = './media/snd_music.ogg';
