...
function (g) {
    ...
    m.VERSION = "3.4.1", m.TRANSITION_DURATION = 150, m.DEFAULTS = {
        ...
        //原本一般是获取data-original-title属性值，一般是站点URL，这里改成使用站点的description文本
        var t = this.$element.find('.overflowClip_2').eq(0),
            e = this.options;
        return t.text() || ("function" == typeof e.title ? e.title.call(t[0]) : e.title)
