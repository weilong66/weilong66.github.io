...
if (!ipv4Regex.test(hostname) && firstDotIndex !== -1) { // 确保找到了至少一个'.'
    ...
    // 如果没有找到'.'，即没有子域名的情况，则直接使用原始域名+拼接umami的本地端口（这里请改成你自己使用的端口）
...
var scriptUrls = [
    ...
    "https://umami.lan.cn:8440/script.js", // 第2个URL
    "https://umami.dpdns.org:8443/script.js", // 第3个URL
    "https://umami.weilong66.dynv6.net:8443/script.js" // 第3个URL
];
